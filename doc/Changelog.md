...
[Sections](doc/API-Sections.md) simplifies the creation of root properties of apps or big components. 
...
For more read the [Debugging](doc/API-Debugging.md) section.
